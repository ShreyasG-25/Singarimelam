...
<body>
	...
	<div id="data">
		<form class="myform" name="idsearch" action="accept.php" method="post">
				<h3>Give booking request id</h3>
				<label><b>ID</b></label>
				<input name="id" type="text" class="inputvalues" placeholder="Booking request id" required/><br>
				<input name="submit_btn" type="submit" id="accept_btn" value="Accept"/><br>
				<a href="adminpanel.php"><input type="button" id="accept_btn" value="Back"/></a><br>		
			</form>
		<?php
		error_reporting(0);
		...
		$result1=mysqli_query($con,$sql);
                ...
                {        
					$query="UPDATE book_info SET accept='yes' WHERE id=$id";
					$query_run=mysqli_query($con,$query); 
					if($query_run)
					{
					echo"Booking request accepted successfully..  <br>";
								...
								while($rows=mysqli_fetch_assoc($result2))
								{
	                                ...
	                                $message="Congratulation ".$name." your event is booked successfully for the date ".$date." Please note that the final payment agreed upon your event is ".$pay." ₹ and it cannot be compromised unless and until direct contact with the team owner. Contact us for any further querries. Thankyou!";
