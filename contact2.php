                                ...
                                <div class="main-menu  d-none d-lg-block">
                                    <nav>
                                        <ul id="navigation">
                                            ...
                                            <li><a class="" href="travel_destination.html">Book now</a></l/li>
                                            <li><a href="">Login <i class="ti-angle-down"></i></a>
                                                <ul class="submenu">
                                                        <li><a href="destination_details.html">Admin</a></li>
    ...
    <section class="contact-section">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-8">
                        <form class="form-contact contact_form" action="contact2.php" method="post" id="contactform" novalidate="novalidate">
                            <div class="row">
                                <div class="col-12">
                        ...
                        <?php
                            if(isset($_POST['submit_btn'])) {
                                ...
                                mail(sk6518191@gmail.com, $subject, $message);  
                            }
                                ?>
