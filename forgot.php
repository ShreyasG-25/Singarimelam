	...
	<head>
		...
		<body style="background-color:#7f8c8d">
			...
			<form class="myform" action="forgot.php" method="post">
				...
				<a href="login.php"><input type="button" id="register_btn" value="Login"/></a>
			</form>
			<?php
					...
					if(mysqli_num_rows($query_run)>0)
					{
						//username exists
								...
								{	
	                                ...
	                                $message="To reset your password click this link http://localhost/singarimelam/user_reset.php";
